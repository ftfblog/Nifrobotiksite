...
class slider(models.Model):
    ...
    #e_activate = models.BooleanField(default=True,verbose_name="Slider Adının Aktiflik Durumu")
    slider_description = models.TextField(verbose_name="Slider Açıklaması")
    #slider_description_activate = models.BooleanField(default=False,verbose_name="Slider Açıklaması Aktiflik Durumu")
